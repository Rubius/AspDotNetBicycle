...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220712065638_Rename_BicycleBrandsTable")]
    partial class Rename_BicycleBrandsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BicycleBrand", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("Domain.Entities.Bicycle", b =>
                {
                    b.HasOne("Domain.Entities.BicycleBrand", "Brand")
                        .WithMany("Bicycles")
            ...
            modelBuilder.Entity("Domain.Entities.BicycleBrand", b =>
                {
                    b.OwnsOne("Domain.Entities.ValueObjects.Address", "ManufacturerAddress", b1 =>
                        {
                            b1.Property<decimal>("BicycleBrandId")
                                .HasColumnType("decimal(20,0)");
                            ...
                            b1.HasKey("BicycleBrandId");

                            b1.ToTable("BicycleBrands");
